...
const answers = [
   '{userName}の今日の運勢はなんと‼大大吉です。{userName}はもしかしたら宝くじが当たるかも。',
    ...
    '{userName}の今日の運勢は末吉です。{userName}は久しぶりにしゃべったことのないクラスメイトに合うでしょう。',
    '{userName}の今日の運勢は吉凶不分末吉です。{userName}はちょうどいいところでスマホの充電が切れるでしょう。',
    '{userName}の今日の運勢は吉凶相交末吉です。{userName}は寝坊して遅刻するでしょう。',
    '{userName}の今日の運勢は吉凶相半です。{userName}はテスト前日に寝落ちして何もわからないでしょう。',
